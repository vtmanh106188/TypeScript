class Fruit {
    ...
    public async showFruit(): Promise<any> {
        var dataFruit = `
...
var fruitList: { id: string; name: string;}[] = [];
...
async function showFruitArray() {
        ...
        if (inforFruit) inforFruit.innerHTML += fruitList.join("");
        fruitList=[]
}
showFruitArray();
...
class fruitProducts {
    public id: number | undefined;
    public nameProduct: string | undefined;
    public image: string | undefined;
    public price: number | undefined;
    public fr_id: number | undefined;
    
    
    constructor(id: number, nameProduct: string,image: string, price: number, fr_id: number) {
        this.id = id;
    ...
    public async showFruitProducts(): Promise<any> {
        var dataProducts = `
...
// interface
var productsFruitList: { id: number; nameProduct: string; image: string; price:number; fr_id:number}[] = [];
...
async function showFruitProductsArray() {
    ...
    if (inforFruitProducts) inforFruitProducts.innerHTML += productsFruitList.join("");
    productsFruitList=[]
}

showFruitProductsArray()

function addCartFruit(id:any, ten:any, gia:any, hinh:any){
...
// show cart right
    ...
    function showCartItem(arr:any) {
        arr.forEach((item:any, index:any) => {
            ...
            `;
            (document.querySelector("#show_right") as HTMLElement).innerHTML += item_add;
        });
    }
    ...
    (document.querySelector('#total_right') as HTMLElement).innerText = total2.toLocaleString('it-IT', {style : 'currency', currency : 'VND'});