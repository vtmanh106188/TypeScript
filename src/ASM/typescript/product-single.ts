...
.then(e => {
    ...
    `;
    (document.querySelector('#product_item') as HTMLElement).innerHTML = str; 
    
});

function addCart2(id:any, ten:any, gia:any, hinh:any){
    let value_quantity = ( document.querySelector("#quantity") as HTMLInputElement ).value;
