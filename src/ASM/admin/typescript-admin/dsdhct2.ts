...
const  getURL = async(url:any)=>{
  ...
  const showDataOrder = async()=>{
    ...
    dataArrayOrderDetail[0].forEach((e: { product_id: any; id: any; order_id: any; quantity: any; unti_price: any; }) => {
          let nameProduct = dataArrayOrderDetail[1].find((iteam: { id: any; })=>iteam.id==e.product_id);
          ...
          `;
          (document.querySelector('#show_bill_detail')as HTMLInputElement).innerHTML += arr_order_detail;
        })
