      ...
      <div class="col-md-5 col-lg-6">
        <div class="p-l-70 p-t-35 p-l-0-lg">
          ...
          <div class="flex-w flex-m p-t-55 p-b-30">
            ...
            >
              <div class="btn-num-product-down flex-c-m fs-29" onclick="minus()"></div>
              ...
              <div class="btn-num-product-up flex-c-m fs-16" onclick="plus()"></div>
            </div>

            <button
              class="flex-c-m txt-s-103 cl0 bg10 size-a-2 hov-btn2 trans-04 m-b-30 js-addcart1"
              onclick="addCart(${e.id},'${e.name}',${e.price},'${e.image}');" id="btnPS"
            >
              Thêm vào giỏ hàng
            </button>
          </div>
...
function addCart(id, ten, gia, hinh){
    ...
    if(cart==null){
        ...
        else cart.push({id: id, name: ten, price: gia, image: hinh, quantity: value_quantity});
...
const minus = () => {
    document.querySelector("#quantity").value == 1 ? (document.querySelector("#quantity").value = 1) : document.querySelector("#quantity").value--;
};
